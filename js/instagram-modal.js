import createModal from "./instagram-create-modal.js"; //змінити на Гітхаб
createModal();
...
class Modal {
  ...
  openModal() {
    modalableImages.forEach((btn) => (btn.tanIndex = "-1"));
  ...
  closeModal() {
    ...
    isMoving = false;
    modalableImages.forEach((btn) => (btn.tanIndex = "0"));
...
// move the array of images (show 2nd image as a 1st)
...
// event listeners 
// відкриття модалки кліком на кнопку
...
// закриття модалки кнопкою Escape
