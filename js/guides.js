  ...
  const guidesData = [
    {
      ...
      title:
        "Ann joined the staff of Cilantro in 2012. She is an expert tour guide. She knows all the gems and the best sights to discover in France.",
    ...
    },
    {
      ...
      title:
        "Paul is our licensed senior tour agent with more than 10 years of travel industry experience under his belt.",
    ...
    },
    {
      ...
      title:
        "Joyce joined our team as a travel guide. She is always very friendly and attentive to clients to help them get a memorable travel experience.",
      languages: "English, French",
    },
  ];

  function renderGuideCard(guidesData) {
    const cilantroGuidesCards = document.querySelector(
      ".cilantro-guides__cards"
    );
